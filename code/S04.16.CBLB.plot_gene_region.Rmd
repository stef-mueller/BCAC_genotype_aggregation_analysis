---
title: "S04.16.CBLB.plot_gene_region"
...
### Set Gene
```{r}
CURRENT_GENE = gene_id_map %>% filter(gene == "CBLB")
```
...
pf3 = ggplot(bcac_current.lift,
  ...
  geom_hline(aes(yintercept = monster_current$neg_log_meta_euro_raw),
                 linetype="dashed",
                 color=mycols[2]) +
  geom_hline(aes(yintercept = -log10(0.0000211)), #unadjusted pvalue in african cohort
             color="forestgreen")
```
