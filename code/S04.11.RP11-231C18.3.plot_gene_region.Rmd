---
title: "S04.11.RP11-231C18.3.plot_gene_region"
...
### Set Gene
```{r}
CURRENT_GENE = gene_id_map %>% filter(gene == "RP11-231C18.3")
```
...
```{r}
pf1 = gene_model %>%
  mutate(gene_of_interest =  ifelse(external_gene_name=="AC058822.1", TRUE, FALSE)) %>% 
