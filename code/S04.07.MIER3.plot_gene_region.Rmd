---
title: "S04.07.MIER3.plot_gene_region"
...
### Set Gene
```{r}
CURRENT_GENE = gene_id_map %>% filter(gene == "MIER3")
```
...
# override xlim fir MIER3 to make plot easier to understand, as no variants outside of
# this manual window have been included in MIER3 gene aggregation model
xlim = c(56919000, 56971675)
```
...
```{r}
pf1 =  gene_model %>%
  # remove SETD9 gene from plot as region is no longer included
  filter(external_gene_name == "MIER3") %>% 
