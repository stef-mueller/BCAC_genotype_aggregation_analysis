---
title: "S04.04.TNNT3.plot_gene_region"
...
```{r}
genes_diverse=c("RP11-231C18.3","SRGAP2C","MAP3K1","FAM175A","BTN2A1","MIER3","TNNT3","LSP1","FMNL3","FAM72B","FGFR1","ZNF404","LYPD5","KCNN4")

id_diverse=c(2312,2578,3587,5340,6639,8691,10113,11289,11889,13017,13061,13984,16771,16809)

genes_euro=c("FAM72B","SRGAP2C","RP11-231C18.3","FAM175A","MAP3K1","MIER3","BTN2A1","FGFR1","LSP1","TNNT3","FMNL3","KCNN4","LYPD5","ZNF404")
...
# Create individual gene data: TNNT3
## Load MONSTER SNPlist
### Set Gene
```{r}
CURRENT_GENE = gene_id_map %>% filter(gene == "TNNT3")
```
...
# override xlim fir TNNT3 to make plot easier to understand, as no variants outside of
# this manual window have been included in TNNT3 gene aggregation model
xlim = c(1850904, 1955904)
...
```{r}
pf1 =  gene_model %>%
  # remove MRPL23 gene from plot as region is no longer included
  filter(external_gene_name != "MRPL23") %>% 
  ggplot(aes(xmin = start_position, xmax = end_position,                             y = external_gene_name, 
